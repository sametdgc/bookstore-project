...
const RegisterForm = () => {
  ...
  const handleRoleChange = (e) => {
    setRole(parseInt(e.target.value)); // Parse the value as an integer
  };
    ...
    try {
      ...
      if (error) {
        ...
        const { data, error: insertError } = await supabase.from('users').insert([
          {
            //user id is generated by the postgres sequence
            full_name: fullName,
            email: email,
            tax_id: taxId,
            phone_number: phone,
          ...
          <div className="flex space-x-6 mt-2">
            <div className="flex items-center">
              <input 
                ...
                id="customer" 
                name="role" 
                value={1}  // Encode role ID as 1 for 'Customer'
                checked={role === 1}  // Compare with integer 1
            ...
            <div className="flex items-center">
              <input 
                ...
                id="salesManager" 
                name="role" 
                value={2}  // Encode role ID as 2 for 'Sales Manager'
                checked={role === 2}  // Compare with integer 2
                onChange={handleRoleChange} 
                className="h-5 w-5 text-orange-500 focus:ring-orange-500 border-gray-300 rounded-full"
              />
            ...
            <div className="flex items-center">
              <input 
                ...
                id="productManager" 
                name="role" 
                value={3}  // Encode role ID as 3 for 'Product Manager'
                checked={role === 3}  // Compare with integer 3
                onChange={handleRoleChange} 
                className="h-5 w-5 text-orange-500 focus:ring-orange-500 border-gray-300 rounded-full"
              />
