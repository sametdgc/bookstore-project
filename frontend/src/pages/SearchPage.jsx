...
import BookCard from "../components/common/BookCard"; // Adjust the import path for BookCard

const SearchPage = () => {
  const [filteredBooks, setFilteredBooks] = useState([]);
  const { state } = useLocation(); // Get the state passed from the SearchBar
  ...
  return (
    <div className="container mx-auto p-6 font-sans">
      <h1 className="text-4xl font-bold mb-8 text-center text-[#65aa92]">Search Results</h1>
